...
export const ThemeSettings: FC = () => {
  ...
  const curThemeName = localStorage.getItem('appTheme') || 'DropEngineTheme';
          ...
          >
            <ThemeToggleWrapper>
              ...
              <Stack alignItems="center" spacing={2}>
                <Tooltip placement="left" title="DropEngine" arrow>
                  <ButtonWrapper
                    className={theme === 'DropEngineTheme' ? 'active' : ''}
                    onClick={() => {
                      changeTheme('DropEngineTheme');
                    }}
                  >
                    {theme === 'DropEngineTheme' && (
                      <CheckSelected>
                        <CheckTwoToneIcon />
                      </CheckSelected>
                    )}
                    <ColorSchemeWrapper className="colorSchemeWrapper dropEngine">
