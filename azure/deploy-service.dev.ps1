...
$result = az deployment group create --resource-group $rgService --template-file .\main.template.bicep --parameters .\main.template.parameters.json --parameters service=$service env=$env location=$location | ConvertFrom-Json
