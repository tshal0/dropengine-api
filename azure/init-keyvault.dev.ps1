...
param ($service='dropengine', $location='eastus', $env='dev', $iteration='001')
...
az deployment group create --resource-group $rgService --template-file .\modules\kv\kv.template.bicep --parameters .\modules\kv\kv.parameters.dev.ignore.json --parameters kvName=$kvName
